...
class DonationCard extends StatelessWidget {
  ...
  DonationCard({required this.donate});
                      ...
                      child: Row(
                          children: <Widget> [
                            if(this.donate.condition[0] == 'NEW') 
                              Tag(donate: donate, color: tagYellow, no:0),
                            if(this.donate.condition[1] == 'SLIGHTLY USED') 
                              Tag(donate: donate, color: tagGreen, no:1),
                            if(this.donate.condition[2] == 'HEAVILY USED')
                              Tag(donate: donate, color: tagBlue, no:2),
                          ],
                        ),
                    ),
                  ),
